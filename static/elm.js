	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'AssignPieceToGroup':
				var pid = msg.a;
				var _v25 = model.selectedGroupId;
				if (_v25.$ === 'Nothing') {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				} else {
					var gid = _v25.a;
