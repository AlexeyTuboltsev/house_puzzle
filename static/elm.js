	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'GotPiecePolygons':
				if (msg.a.$ === 'Ok') {
					...
					var updatedPieces = A2(
						$elm$core$List$map,
						function (p) {
							var _v14 = A2($elm$core$Dict$get, p.id, polyDict);
							if (_v14.$ === 'Just') {
								var poly = _v14.a;
								return _Utils_update(
									p,
			...
			case 'DropOnWave':
				...
				var _v17 = model.draggingPieceId;
				if (_v17.$ === 'Nothing') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
			...
			case 'AssignPieceToGroup':
				var pid = msg.a;
				var _v23 = model.selectedGroupId;
				if (_v23.$ === 'Nothing') {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				} else {
					var gid = _v23.a;
			...
			case 'DropOnGroup':
				var mgid = msg.a;
				var _v24 = model.draggingPieceId;
				if (_v24.$ === 'Nothing') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
			...
			case 'SetHouseUnitsHigh':
				var s = msg.a;
				var _v31 = $elm$core$String$toFloat(s);
				if (_v31.$ === 'Just') {
					var h = _v31.a;
			...
			case 'StartColorPick':
				...
				var currentHue = _v32.a;
				var currentOpacity = _v32.b;
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text(
												'Piece ID: ' + $elm$core$String$fromInt(piece.id))
											])),
										A2(
										$elm$html$Html$div,
										_List_fromArray(
